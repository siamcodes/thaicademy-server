...
router.put("/admin/post/publish/:postId", requireSignin, isAdmin, publishPostByAdmin);
router.put("/admin/post/unpublish/:postId", requireSignin, isAdmin, unpublishPostByAdmin);
