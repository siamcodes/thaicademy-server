...
router.post("/admin/refresh-user-status", requireSignin, isAdmin, refreshUserStatus);
// help and support
router.delete("/admin/issue/delete/:issueId", requireSignin, isAdmin, removeIssue);
