...
router.delete("/qa/answer-delete-by-instructor/:answerId", requireSignin, deleteAnswerByInstructor);

router.delete("/qa/answer-delete/:answerId/:postedBy", requireSignin, deleteAnswer);
// lessons <> questions
router.post("/qa", requireSignin, create);

// by instructor
router.put("/qa/mark-resolved-by-instructor", requireSignin, markQaResolvedByInstructor);
router.put("/qa/mark-unresolved-by-instructor", requireSignin, markQaUnresolvedByInstructor);
